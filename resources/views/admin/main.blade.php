...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li id="liSeguridad" class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a id="liUsuario" href="/user" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Usuarios</p>
                  </a>
                </li>
    ...
    <aside class="control-sidebar control-sidebar-dark">
      ...
      <div class="p-3">
        <h5>Plantilla</h5>
        <p>Desarrollado por mrodriguezbrand</p>
      </div>
    </aside>
    <!-- /.control-sidebar -->
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2024 <a href="https:incanatoit.com">IncanatoApps</a>.</strong> Derechos reservados.
    </footer>
  </div>
  <!-- ./wrapper -->
